<template>
  <footer class=" p-8 pt-24 border-t dark:border-gray-600 md:p-6">
    ...
    <div class="flex flex-row flex-wrap justify-between md:container mx-auto gap-6">
      ...
      <div class="flex flex-col gap-3 w-full md:w-[35%]">
        ...
        <img src="../assets/images/logo/whatsell_logo.png" class=" w-[120px]"/>
        <p class=" mt-4">
        ...
        <!-- WhatsApp Channel -->
        <div class="mt-6">
          <h3 class="font-semibold">Join Our WhatsApp Channel</h3>
          <p class="">Access, stay up to date and grow with WhatSell</p>
    ...
    <div class="container flex flex-row flex-wrap md:justify-between items-center border-t mx-auto py-8 gap-6 mt-4 font-bold dark:border-gray-600">
      <!-- Social Media Icons -->
      ...
      <!-- Copyright -->
      <p class="">&copy; All Rights reserved by WhatSell 2024</p>
    </div>
