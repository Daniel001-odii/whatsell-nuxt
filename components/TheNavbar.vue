                ...
                <div class="flex gap-12 items-center justify-evenly">
                    <div
                        ...
                        <NuxtLink to="/" class="flex flex-col items-center" :class="isHomePage ? 'text-green-500':''">
                            ...
                            <svg class="md:hidden" width="30" height="30" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <NuxtLink to="/shops" class="flex flex-col items-center" :class="isShopsPage ? 'text-green-500':''">
                            ...
                            <svg class="md:hidden" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <NuxtLink to="/glips" class="flex flex-col items-center" :class="isGlipsPage ? 'text-green-500':''">
                            ...
                            <svg class="md:hidden" width="25" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
