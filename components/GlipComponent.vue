<template>
    <div class="video-reel md:rounded-lg overflow-hidden" ref="videoContainer">
        ...
        <div class="absolute top-0 p-5">
            <button @click="" class=" bg-black bg-opacity-50 rounded-full p-4 justify-center items-center">
            ...
            <div class=" relative">
                <div class=" flex flex-col-reverse gap-4 absolute bottom-[80px] right-0 items-center">
                    <button @click="toggleMute" class="rounded-full p-4 justify-center items-center">
                        ...
                        <svg v-if="isMuted" xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><g fill="none" stroke="#ffffff" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="m18 14l2-2m2-2l-2 2m0 0l-2-2m2 2l2 2"></path><path d="M2 13.857v-3.714a2 2 0 0 1 2-2h2.9a1 1 0 0 0 .55-.165l6-3.956a1 1 0 0 1 1.55.835v14.286a1 1 0 0 1-1.55.835l-6-3.956a1 1 0 0 0-.55-.165H4a2 2 0 0 1-2-2Z"></path></g></svg>
                        <svg v-else xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><g fill="none" stroke="#ffffff" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 7.5S21 9 21 11.5s-1.5 4-1.5 4"></path><path d="M2 13.857v-3.714a2 2 0 0 1 2-2h2.9a1 1 0 0 0 .55-.165l6-3.956a1 1 0 0 1 1.55.835v14.286a1 1 0 0 1-1.55.835l-6-3.956a1 1 0 0 0-.55-.165H4a2 2 0 0 1-2-2Z"></path></g></svg>
                    </button>

                    <button class="  rounded-full p-4 justify-center items-center">
                        <!-- <i class="bi bi-shop text-xl"></i> -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><g fill="none" stroke="#ffffff" stroke-width="1.5"><path d="M20.485 3h-3.992l.5 5s1 1 2.5 1a3.23 3.23 0 0 0 2.139-.806a.5.5 0 0 0 .15-.465L21.076 3.5a.6.6 0 0 0-.591-.5Z"></path><path d="m16.493 3l.5 5s-1 1-2.5 1s-2.5-1-2.5-1V3z"></path><path d="M11.993 3v5s-1 1-2.5 1s-2.5-1-2.5-1l.5-5z"></path><path d="M7.493 3H3.502a.6.6 0 0 0-.592.501L2.205 7.73a.5.5 0 0 0 .15.465c.328.29 1.061.806 2.138.806c1.5 0 2.5-1 2.5-1z"></path><path d="M3 9v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V9"></path><path stroke-miterlimit="16" d="M14.833 21v-6a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v6"></path></g></svg>
                    </button>
                    <button class=" rounded-full p-4 justify-center items-center">
                        <!-- <i class="bi bi-share text-xl"></i> -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><g fill="none" stroke="#ffffff" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M18 22a3 3 0 1 0 0-6a3 3 0 0 0 0 6m0-14a3 3 0 1 0 0-6a3 3 0 0 0 0 6M6 15a3 3 0 1 0 0-6a3 3 0 0 0 0 6"></path><path d="m15.5 6.5l-7 4m0 3l7 4"></path></g></svg>
                    </button>
                </div>
